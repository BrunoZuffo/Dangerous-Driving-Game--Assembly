...
;                   IMPRIME CENÁRIO
;********************************************************
ImprimeCenario:  ; Rotina de impressão do cenário
    ; Este código é idêntico ao ImprimeStr
    rts

; Declaração das linhas do cenário
...
printtelamenu_Loop:
    ...
    inc r1  ; Pula o '\0' no final da linha
printtelamenu_skip:
    cmp r1,r2
